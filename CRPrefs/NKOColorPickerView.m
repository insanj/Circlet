...
- (void)setTintColor:(UIColor *)tintColor
{
    ...
    self.brightnessIndicator.image = [[UIImage imageNamed:@"nko_brightness_guide" inBundle:[NSBundle bundleForClass:self.class]] nko_tintImageWithColor:tintColor];
}
...
- (UIImageView*)hueSatImage
{
    if (self->_hueSatImage == nil){
        self->_hueSatImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"nko_colormap.png" inBundle:[NSBundle bundleForClass:self.class]]];
...
- (UIImageView*)brightnessIndicator
{
    if (self->_brightnessIndicator == nil){
        ...
        self->_brightnessIndicator.image = [[UIImage imageNamed:@"nko_brightness_guide" inBundle:[NSBundle bundleForClass:self.class]] nko_tintImageWithColor:[self _defaultTintColor]];
