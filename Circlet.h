...
#define COMPARE_IOS(v) (kCFCoreFoundationVersionNumber >= v)
#define NEWEST_IOS COMPARE_IOS(kCFCoreFoundationVersionNumber10_7_1)
#define MODERN_IOS COMPARE_IOS(kCFCoreFoundationVersionNumber10_7)
